...
fun PlaybackGlassMenu(
    ...
    AccessibleClickSurface(
        ...
        accessibilityLabel = AccessibilitySupport.playbackButtonLabel(chapter, isPlaying),
        accessibilityHint = AccessibilitySupport.playbackButtonHint(isPlaying)
    ) {
        Box(
            modifier = Modifier
                .fillMaxSize()
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Icon(
                    ...
                    modifier = Modifier.size(AppControlLayout.playbackBarIconSize)
                )
                Text(
                    text = chapter.title,
                    modifier = Modifier
